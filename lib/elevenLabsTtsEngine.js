...
// ElevenLabsのプリメイド音声(どのアカウントでも使える既定ID)。
// main=女性寄り(Rachel), sub=男性寄り(Adam)。UIで上書き可能。
export const DEFAULT_MAIN_VOICE = '21m00Tcm4TlvDq8ikWAM';
export const DEFAULT_SUB_VOICE = 'pNInz6obpgDQGcFmaJgB';

...
// main=ボブ(ホスト) → Charlie(Deep, Confident, Energetic/ファンキーな低音),
// sub=お便り朗読 → River(Relaxed, Neutral/手紙の朗読に合う落ち着いた声)。
export const DEFAULT_MAIN_VOICE = 'IKne3meq5aSn9XLyUdCD';
export const DEFAULT_SUB_VOICE = 'SAz9YHcvj6GT2YYXdXww';

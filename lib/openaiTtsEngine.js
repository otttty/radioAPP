...
export class OpenAITTSEngine {
  ...
  constructor(opts) {
    ...
    this.voices = { main: 'onyx', sub: 'shimmer' };
    this.instructions = {
      main:
        'ラジオ番組のメインDJとして話してください。明るくテンポよく、リスナーに語りかけるように。' +
        '生放送のような軽快さと勢いを持たせ、間延びさせず小気味よいテンポで、抑揚をしっかりつけて話してください。',
      sub:
        'リスナーから届いたお便り(ラジオメール)を朗読している声として話してください。' +
        '手紙を読み上げるような、落ち着いた自然で親しみのあるトーンで。DJほどテンションは上げず、' +
        '体験を語るように柔らかく話してください。',
    };
    this._audioCtx = null;
